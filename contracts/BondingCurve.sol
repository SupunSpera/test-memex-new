    ...
    IERC721Receiver
{
    ...
    function initialize(
        ...
        // Start directly in Bonding phase with initial reserves
        currentPhase = Phase.Bonding;
        ethReserve = settings.virtualEth;
        tokenReserve = token.balanceOf(address(this)); // Full 10B token supply
        totalETHCollected = 0;
    }
        ...
        returns (uint256 tokensToReceive)
    {
        ...
        if (totalETHCollected + msg.value > settings.bondingTarget)
